...
Catch_AllYrs = xtable(Catch_AllYrs, 
                      caption = c('Landings for each state (all gears combined), the at-sea hake fishery, the foreign fleet, and surveys.'),
...
# Index of abundance summary, create table   
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of Triennial shelf survey length samples used in the stock assessment.'),
...
# Index of abundance summary, create table   
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of Triennial shelf survey age samples used in the stock assessment.'),
...
# Convert Q to regular space
#mod_params[mod_params$Label == "LnQ_base_Fishery(1)",3] = format(exp(mod_params[mod_params$Label == "LnQ_base_Fishery(1)",3]), scientific = TRUE)
#mod_params[mod_params$Label == "LnQ_base_POP(4)",3] = exp(mod_params[mod_params$Label == "LnQ_base_POP(4)",3])
#mod_params[mod_params$Label == "LnQ_base_Triennial(5)",3] = exp(mod_params[mod_params$Label == "LnQ_base_Triennial(5)",3])
#mod_params[mod_params$Label == "LnQ_base_AFSCSlope(6)",3] = exp(mod_params[mod_params$Label == "LnQ_base_AFSCSlope(6)",3])
#mod_params[mod_params$Label == "LnQ_base_NWFSCSlope(7)",3] = exp(mod_params[mod_params$Label == "LnQ_base_NWFSCSlope(7)",3])
#mod_params[mod_params$Label == "LnQ_base_NWFSCcombo(8)",3] = exp(mod_params[mod_params$Label == "LnQ_base_NWFSCcombo(8)",3])
...
#mod_params[mod_params$Label == "LnQ_base_Fishery(1)",2] = "Q_base_Fishery(1)"
#mod_params[mod_params$Label == "LnQ_base_POP(4)",2] = "Q_base_POP(4)"
#mod_params[mod_params$Label == "LnQ_base_Triennial(5)",2] = "Q_base_Triennial(5)"
#mod_params[mod_params$Label == "LnQ_base_AFSCSlope(6)",2] = "Q_base_AFSC_Slope(6)"
#mod_params[mod_params$Label == "LnQ_base_NWFSCSlope(7)",2] = "Q_base_NWFSC_Slope(7)"
#mod_params[mod_params$Label == "LnQ_base_NWFSCcombo(8)",2] = "Q_base_NWFSCcombo(8)"
