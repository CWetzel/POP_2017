...
#_SS-V3.30.01.09-trans;_2017_01_24;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_11.2
#_SS-V3.30.01.09-trans;user_support_available_at:NMFS.Stock.Synthesis@noaa.gov
#_SS-V3.30.01.09-trans;user_info_available_at:https://vlab.ncep.noaa.gov/group/stock-synthesis
...
#_ LO HI INIT PRIOR PR_SD PR_type PHASE env_var&link dev_link dev_minyr dev_maxyr dev_PH Block Block_Fxn
 ...
 -1 1 0.0271907 0.05 0.1 6 2 0 0 0 0 0 0 0 # NatM_p_1_Mal_GP_1
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             5            20       9.14088            10             5             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
           0.2             1           0.4          0.78         0.165             0         -3          0          0          0          0          0          0          0 # SR_BH_steep
...
1 # (0/1) to read 13 advanced options
 1880 #1932 #_recdev_early_start (0=none; neg value makes relative to recdev_start)
 3 #_recdev_early_phase
 5 #_forecast_recruitment phase (incl. late recr) (0 value resets to maxphase+1)
 1 #_lambda for Fcast_recr_like occurring before endyr+1
 1954 #_last_early_yr_nobias_adj_in_MPD
 1970 #_first_yr_fullbias_adj_in_MPD
 2011 #2006 #_last_yr_fullbias_adj_in_MPD
...
# Fishery 0.000189941 0.000284955 0.000506698 0.00180582 0.00317256 0.00481823 0.00381457 0.00324906 0.00348097 0.00916505 0.0134361 0.0165465 0.0386954 0.0291194 0.0429224 0.0341267 0.056751 0.0505514 0.0409351 0.0267263 0.0461035 0.0670819 0.0930023 0.131792 0.154373 0.218736 0.649075 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.949927
#
#_Q_setup
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
           -15            15      -10.5584             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_Fishery(1)
           -15            15       6.72761             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_POP(2)
           -15            15       6.14293             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_EarlyTriennial(3)
           -15            15       11.1095             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_LateTriennial(4)
           -15            15       11.5304             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_AFSCSlope(5)
           -15            15       11.6124             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_NWFSCSlope(6)
           -15            15       13.2616             0             1             0         -1          0          0          0          0          0          0          0  #  LnQ_base_NWFSCcombo(7)
...
#
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
            20            45       36.6071            28            50             0          2          0          0          0          0          0          0          0  #  SizeSel_P1_Fishery(1)
            -6             4            -5            -1            50             0         -2          0          0          0          0          0          0          0  #  SizeSel_P2_Fishery(1)
            -1             9       3.25742             4            50             0          3          0          0          0          0          0          0          0  #  SizeSel_P3_Fishery(1)
            -1             9       0.63319             4            50             0          3          0          0          0          0          0          0          0  #  SizeSel_P4_Fishery(1)
            -5             9       -2.7369            -4            50             0          4          0          0          0          0          0          0          0  #  SizeSel_P5_Fishery(1)
            -5             9      0.997914            -2            50             0          2          0          0          0          0          0          0          0  #  SizeSel_P6_Fishery(1)
            15            45        30.937            35            99             0          1          0          0          0          0        0.5          0          0  #  Retain_P1_Fishery(1)
           0.1            10       1.87861             1            99             0          1          0          0          0          0        0.5          0          0  #  Retain_P2_Fishery(1)
           -10            10      0.759177      0.405465            99             0          1          0          0          0          0        0.5          1          2  #  Retain_P3_Fishery(1)
             0             0             0             0            99             0         -3          0          0          0          0        0.5          0          0  #  Retain_P4_Fishery(1)
            20            70       23.0092            30            99             0          2          0          0          0          0          0          0          0  #  SizeSel_P1_POP(2)
         0.001            50       9.32775            15            99             0          3          0          0          0          0          0          0          0  #  SizeSel_P2_POP(2)
            18            70       20.3233            30            99             0          2          0          0          0          0          0          0          0  #  SizeSel_P1_EarlyTriennial(3)
         0.001            50       5.41883            15            99             0          3          0          0          0          0          0          0          0  #  SizeSel_P2_EarlyTriennial(3)
            20            70       25.8541            30            99             0          2          0          0          0          0          0          0          0  #  SizeSel_P1_NWFSCcombo(7)
         0.001            50       17.2909            15            99             0          3          0          0          0          0          0          0          0  #  SizeSel_P2_NWFSCcombo(7)
# timevary selex parameters 
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type    PHASE  #  parm_name
#         0.001             1         0.999           0.9            99             6      -1  # Retain_P3_Fishery(1)_BLK1repl_1940
#         0.001             1          0.98           0.9            99             6      -1  # Retain_P3_Fishery(1)_BLK1repl_1982
#         0.001             1      0.964378          0.88            99             6      1  # Retain_P3_Fishery(1)_BLK1repl_1989
#         0.001             1      0.905894          0.82            99             6      1  # Retain_P3_Fishery(1)_BLK1repl_1995
#         0.001             1      0.497125          0.65            99             6      1  # Retain_P3_Fishery(1)_BLK1repl_2009
           -10            10      	10             10            99             0      -1
           -10            10      	10             10            99             0      -1
           -10            10      	 7      	9            99             0       1
           -10            10      	 3      	3            99             0       1
           -10            10      	0.1           0.1            99             0       1
