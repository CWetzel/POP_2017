...
#_SS-V3.30.0.0-trans;_2016_10_13;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_11.2
...
#_      LO        HI      INIT     PRIOR   PR_SD   PR_type        PHASE env-var use_dev dev_mnyr dev_mxyr dev_PH   Block Blk_Fxn  #  parm_name
          5         20       10.2         10          5          0       1       0       0       0       0       0       0       0 # SR_LN(R0)
...
# Fishery 4.84199e-005 7.26323e-005 0.000129131 0.000460071 0.000807408 0.00122393 0.000966241 0.000821235 0.000878334 0.00230841 0.00336667 0.00411439 0.009532 0.00701014 0.0101644 0.00788411 0.0128718 0.0111001 0.00874529 0.00559562 0.00955652 0.0136026 0.0182034 0.0244749 0.0264725 0.0340964 0.0875499 0.0719935 0.0478387 0.0105492 0.0127463 0.0113997 0.0111646 0.0158346 0.0137824 0.00789603 0.0101124 0.00976451 0.0134247 0.0109695 0.0123827 0.0082166 0.00655471 0.00988296 0.0100495 0.00911351 0.00884385 0.00694901 0.00877564 0.00981575 0.00747975 0.00982887 0.00964857 0.00875383 0.0073189 0.00666793 0.00617269 0.0050693 0.00505369 0.00405104 0.00105944 0.00210022 0.00119273 0.00106433 0.000967921 0.000507182 0.000569765 0.00104318 0.000776005 0.000998978 0.000819461 0.00111556
#
#_Q_setup
...
#_      LO        HI      INIT     PRIOR   PR_SD  PR_type      PHASE env-var use_dev dev_mnyr dev_mxyr dev_PH   Block Blk_Fxn  #  parm_name
        -15         15   -13.5598          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_Fishery(1)
        -15         15   -2.31978          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_POP(2)
        -15         15   -3.56038          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_EarlyTriennial(3)
        -15         15   -4.09537          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_LateTriennial(4)
        -15         15    -3.7565          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_AFSCSlope(5)
        -15         15   -4.19759          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_NWFSCSlope(6)
        -15         15   -3.11695          0          1          0      -1       0       0       0       0       0       0       0  #  LnQ_base_NWFSCcombo(7)
...
#
#_      LO        HI      INIT     PRIOR      PR_SD    PR_type  PHASE env-var use_dev dev_mnyr dev_mxyr dev_PH   Block Blk_Fxn  #  parm_name
         20         45         31         28         50          0       2       0       0       0       0       0       0       0  #  SizeSel_P1_Fishery(1)
         -6          4         -5         -1         50          0      -2       0       0       0       0       0       0       0  #  SizeSel_P2_Fishery(1)
         -1          9          2          4         50          0       3       0       0       0       0       0       0       0  #  SizeSel_P3_Fishery(1)
         -1          9          0          4         50          0       3       0       0       0       0       0       0       0  #  SizeSel_P4_Fishery(1)
         -5          9      -4.99         -4         50          0       4       0       0       0       0       0       0       0  #  SizeSel_P5_Fishery(1)
         -5          9          1         -2         50          0       2       0       0       0       0       0       0       0  #  SizeSel_P6_Fishery(1)
         15         45         27         35         99          0       1       0       0       0       0     0.5       0       0  #  Retain_P1_Fishery(1)
        0.1         10          2          1         99          0       1       0       0       0       0     0.5       0       0  #  Retain_P2_Fishery(1)
      0.001          1        0.7        0.6         99          0       1       0       0       0       0     0.5       1       2  #  Retain_P3_Fishery(1)
          0          0          0          0         99          0      -3       0       0       0       0     0.5       0       0  #  Retain_P4_Fishery(1)
         20         70         25         30         99          0       2       0       0       0       0       0       0       0  #  SizeSel_P1_POP(2)
      0.001         50         11         15         99          0       3       0       0       0       0       0       0       0  #  SizeSel_P2_POP(2)
         18         70         25         30         99          0       2       0       0       0       0       0       0       0  #  SizeSel_P1_EarlyTriennial(3)
      0.001         50         11         15         99          0       3       0       0       0       0       0       0       0  #  SizeSel_P2_EarlyTriennial(3)
         20         70         25         30         99          0       2       0       0       0       0       0       0       0  #  SizeSel_P1_NWFSCcombo(7)
      0.001         50         11         15         99          0       3       0       0       0       0       0       0       0  #  SizeSel_P2_NWFSCcombo(7)
...
#_      LO        HI      INIT     PRIOR   PR_SD  PR_type       PHASE
      ...
      0.001          1        0.9       0.88         99          6      1  # Retain_P3_Fishery(1)_BLK1repl_1989
      0.001          1        0.8       0.82         99          6      1  # Retain_P3_Fishery(1)_BLK1repl_1995
      0.001          1        0.6       0.65         99          6      1  # Retain_P3_Fishery(1)_BLK1repl_2009
