...
The models explored regarding steepness either using the mean of the prior or the value supported by the Triennial shelf survey index led to quite different estimates of depletion for `r spp` in 2017.  Given the insufficient information to estimate steepness within the model an alternative approach for determining steepness was proposed by Dr. Owen Hamel during the SSC GFSC webinar held on September 28, 2017.  The subcommittee states that:
