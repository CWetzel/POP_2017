...
meters) on an annual basis (referred to as the `NWFSC Slope/Shelf
Survey').
...
\textbf{\emph{West Coast Groundfish Observer Program}}
...
The estimated index of abundance is shown in \ref{tab:Index_Summary}.
...
collected from the NWFSC Slope/Shelf survey. This is revised from the
