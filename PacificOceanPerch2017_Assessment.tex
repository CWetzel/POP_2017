...
\ref{tab:Timeseries_mdo1}. Estimates of key derived parameters and
...
by the model and show no obvious pattern in the residuals (Figures
\ref{fig:_mod1_comp_lenfit_flt1mkt} and
\ref{fig:mod1_2_comp_lenfit_residsflt1mkt1}).
