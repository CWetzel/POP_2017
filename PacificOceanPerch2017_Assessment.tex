...
(\textless{} 200 m) with only larger individuals occuring at depths
...
expanded based upon the survey stratifcation (Tables
...
\ref{tab:Index_Summary}. The lognormal distrubution with random
...
conducted. No age data were avaialable from this survey. The expanded
...
availabe ages from the Triennial survey and the number of tows where
...
al. \protect\hyperlink{ref-ianelli_status_1992}{1992}). TAn index of
...
\ref{tab:POP_Lengths}) and ages were only availabe in 1985 due to
...
assessment. Additional cathes from 1987-1999 for Pacific ocean perch
...
data were collected from the bottom trawl fishery, but there additional
biological data were collected from non-trawl gear was grouped together
with all data available. Tables \ref{tab:Comm_Lengths} and
