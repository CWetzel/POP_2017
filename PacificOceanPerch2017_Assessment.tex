...
create the CPUE index was not available for reanalysis and hence was
...
recruitment events in this assessment and varying model specificiatons
...
extra variability for the NWFSC shelf-slope survey indix, 24 parameters
...
0.72. A sensitivity analysis and a likelihood profile were performed for
...
trawl gear. The final base model assumed asymptotic selectivity for the
at-sea hake fishery, and all surveys.
