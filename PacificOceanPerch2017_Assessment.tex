...
stock biomass stabilizing or with a minimimal decline until the late
...
the exploitation rate and \((1-SPR)/(1-SPR_{50\%})\) were mostly above
target levels. Recent exploitation rates on Pacific ocean perch were
...
management target in the 1980s. Managment restrictions imposed in the
...
oocytes as mature or immature based on the proportion of vitellogenin in
the cytoplasm and the measured frequency of atretic cells (M. Head,
personal communication). The updated maturity curve was based on
