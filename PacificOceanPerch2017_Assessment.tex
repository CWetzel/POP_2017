...
ranged from 33 in 2006 to 69 in 2015 \ref{tab:NWcombo_Lengths} where
ages were collected for Pacific ocean perch in nearly every tow
\ref{tab:NWcombo_Ages}. The expanded length frequencies from this survey
show an increase in small fish starting in 2010 (Figure
...
An index of abundance was estiamted based on the data using the VAST
