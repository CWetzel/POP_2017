...
To avoid double use of the length and age data from individual fish, the length and age data sources were each given 0.50 weight in the likelihood calculations when model fitting.  This was applied to length and age data from the main fishery and the at-sea hake fishery.
